<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Warehouse.aspx.cs" Inherits="Warehouse" StyleSheetTheme="SkinFile" %>
      ...
      <asp:Label ID="lblPagehead" runat="server" Text="Warehouse Master" 
                ...
                <table id="Table1" runat="server" width="100%">
                    ...
                    <tr> 
                     ...
                     <asp:Button ID="btnsubmit" runat="server" Text="Add new warehouse" 
