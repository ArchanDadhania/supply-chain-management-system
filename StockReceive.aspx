<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StockReceive.aspx.cs" Inherits="StockReceive" StyleSheetTheme="SkinFile" %>
    ...
    <center>
        <div id="div1" runat="server">
            <center>
                ...
                <br />
      <asp:Label ID="lblPagehead" runat="server" Text="Receive Stock From Company" 
                ...
                <table id="Table1" runat="server" width="100%">
                    <tr>
                        <td align="left" style="height: 24px; text-align: center">
                            Search&nbsp;by Distributor Code:
                            <asp:TextBox ID="TxtDistributorCode" runat="server" Width="98px"></asp:TextBox>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            Product Code:
                    ...
                    <tr> 
                     <td align="left" >
                         <b>Received Orders/Products                      <asp:Label ID="lblmsg2" runat="server" CssClass="MsgLabel"></asp:Label>
                         </b></td>
                    </tr>
                    <tr> 
                     <td align="center" >
