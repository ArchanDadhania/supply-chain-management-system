<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProductMaster.aspx.cs" Inherits="ProductMaster" StyleSheetTheme="SkinFile" %>
      ...
      <asp:Label ID="lblPagehead" runat="server" Text="Product Master" 
                ...
                <table id="Table1" runat="server" width="100%">
                    ...
                    <tr> 
                     ...
                     <asp:Button ID="btnsubmit" runat="server" Text="Add new product" 
